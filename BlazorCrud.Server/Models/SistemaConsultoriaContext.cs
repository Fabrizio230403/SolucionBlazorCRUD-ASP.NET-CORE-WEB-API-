...
public partial class SistemaConsultoriaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Notificacione>(entity =>
        {
            ...
            entity.Property(e => e.Estado).HasMaxLength(1).IsUnicode(false).HasDefaultValue("P").IsFixedLength();
            entity.Property(e => e.FechaEnvio).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
            ...
            entity.HasOne(d => d.Usuario).WithMany(p => p.Notificaciones).HasForeignKey(d => d.UsuarioId).HasConstraintName("FK__Notificac__Usuar__74AE54BC");
        });
        ...
        modelBuilder.Entity<Recurso>(entity =>
        {
            ...
            entity.Property(e => e.Costo).HasDefaultValue(0m).HasColumnType("decimal(10, 2)");
            entity.Property(e => e.Nombre).HasMaxLength(100);
            entity.Property(e => e.ProyectoId).HasColumnName("ProyectoID");
            entity.Property(e => e.TiempoAsignado).HasDefaultValue(0m).HasColumnType("decimal(5, 2)");
            entity.Property(e => e.Tipo).HasMaxLength(1).IsUnicode(false).IsFixedLength();
            entity.Property(e => e.UsuarioId).HasColumnName("UsuarioID");
            entity.HasOne(d => d.Proyecto).WithMany(p => p.Recursos).HasForeignKey(d => d.ProyectoId).HasConstraintName("FK__Recursos__Proyec__6E01572D");
            entity.HasOne(d => d.Usuario).WithMany(p => p.Recursos).HasForeignKey(d => d.UsuarioId).HasConstraintName("FK__Recursos__Usuari__71D1E811");
        });
